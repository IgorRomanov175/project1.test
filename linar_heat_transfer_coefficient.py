node1 = [[0.08, 0.073, 0.062],
         [0.087, 0.082, 0.069],
         [0.094, 0.09, 0.076]]

node2 = [[0.09, 0.074, 0.062],
         [0.1, 0.082, 0.069],
         [0.11, 0.09, 0.076]]
...
def node_1():
    ...
    c = int(input("""Оберіть товщину теплоізоляції:
                         120mm - 1
                         150mm - 2
                         180mm - 3
                         -"""))
    if c == 1:
        d = int(input("""Розрахункова теплопровідність:
            0.040 -- 1
            0.045 -- 2
            0.050 -- 3
            -"""))
